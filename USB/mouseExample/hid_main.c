 ...
 ****************************************************************************/
//	Look in the board.c folder for the GPIO pins used.
...
int main(void)
{
	puts("USB Exercise 2 - USB-mouse example!");
	...
	while (1) {
		...
		//Mouse_adjust(10);	//	Using delays to slower down mouse update, in theory this only creates lagging effect...
